    ...
    /** @lends Gitana.Branches.prototype */
    {
        ...
        list: function(successCallback, failureCallback)
        {
            ...
            var onSuccess = function(response)
            {
                ...
                {
                    list.push(new Gitana.Branch(_this.getRepository(), response.rows[i]));
                }
                response.list = list;
        ...
        query: function(config, successCallback, failureCallback)
        {
            ...
            // invoke
            this.getDriver().gitanaPost("/repositories/" + this.getRepositoryId() + "/branches/query", config, onSuccess, onFailure);
        }

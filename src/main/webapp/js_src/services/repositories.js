...
(function(window) {
    ...
    Gitana.Service.Repositories.prototype.list = function() {
        ...
        this.getDriver().gitanaGet("/repositories", function(response) {
            ...
            for each (row in response.rows) {
                list[list.length] = new Gitana.Object.Repository(_this.getDriver(), row);
            }
            response.list = list;
    ...
    Gitana.Service.Repositories.prototype.read = function() {
        ...
        this.getDriver().gitanaGet("/repositories/" + repositoryId, function(response) {
            ...
            callback(new Gitana.Object.Repository(_this.getDriver(), response));
    ...
    Gitana.Service.Repositories.prototype.create = function() {
        ...
        // invoke
        this.getDriver().gitanaPost("/repositories", repositoryObject, callback, Gitana.ajaxErrorHandler);
    };
    ...
    Gitana.Service.Repositories.prototype.update = function() {
        ...
        // invoke
        this.getDriver().gitanaPut("/repositories/" + repositoryId, repositoryObject, callback, Gitana.ajaxErrorHandler);
    };
    ...
    Gitana.Service.Repositories.prototype.del = function() {
        ...
        // invoke
        this.getDriver().gitanaDelete("/repositories/" + repositoryId, callback, Gitana.ajaxErrorHandler);
    };

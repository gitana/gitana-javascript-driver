var testSearch = function()
{
    ...
    var test1 = function()
    {
        ...
        this.branch.search("fox", function(response) {
            ...
            {
                alert("test1: should have been 5");
            }
    ...
    var test2 = function()
    {
        ...
        this.branch.search("slow", function(response) {
            ...
            {
                alert("test2: should have been 3");
            }
    ...
    var test3 = function()
    {
        ...
        this.branch.search("jumped", function(response) {
            ...
            {
                alert("test3: should have been 8");
            }
    ...
    var test4 = function()
    {
        ...
        this.branch.search("slash", function(response) {
            ...
            {
                alert("test4: should have been 1");
            }
    ...
    var test5 = function()
    {
        ...
        this.branch.search("fox", function(response) {
            ...
            {
                alert("test5: should have been 6");
            }
    ...
    var test6 = function()
    {
        ...
        this.node1.search(config, function(response) {
            ...
            {
                alert("test6: node list should have been 0");
            }
    ...
    var test7 = function()
    {
        ...
        this.branch.search(config, function(response) {
            ...
            {
                alert("test7: node list should have been 2");
            }

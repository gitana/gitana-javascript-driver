(function($) {
    ...
    test("Association operations", function() {
        stop();
        ...
        var test1 = function() {
            this.node1.incomingAssociations(function(response) {
                ok (response["total_rows"] > 0 , "Number of rows should be greater than 0.");
        ...
        var test6 = function() {
            this.node3.outgoingAssociations(function(response) {
                ok (response["total_rows"] == 0 , "Number of rows should be 0.");

    ...
    test("Traversal operations", function() {
        ...
        var test1 = function() {
            ...
            var callback = function(response) {
                ...
                equal(getNumberOfKeys(nodes), 4, "N1 have been size 4");

                var associations = response.associations;
                equal(getNumberOfKeys(associations), 4, "A1 should have been size 4");
        ...
        var test2 = function() {
            var callback = function(response) {
                var nodes = response.nodes;
                equal(getNumberOfKeys(nodes), 13, "N2 have been size 13");
                var associations = response.associations;
                equal(getNumberOfKeys(associations), 13, "A2 should have been size 13");
                test3();
            };
